...
//		
	...
	public CompanyFacade (String compName, String password) throws CouponException
	{
...
//	}
	...
	public void createCoupon(Coupon coupon) throws CouponException, AlreadyExistException, CompanyFacadeException, SQLException
	{
		try {
	...
	public void removeCoupon(Coupon coupon) throws CouponException, DoesNotExistException, SQLException
	{
		...
		try {
			compDAO.removeCompanyCoupon(coupon.getId(), compId);
		} catch (CouponException e) {
			throw new DoesNotExistException("CompanyFacadeException - "
					+ "getCoupon Error", e);
		}
		...
		//Remove Coupon from Customer
			...
			for (long custId: coupDAO.getCustomersId(coupon))
			{
			try {
	...
	public void updateCoupon(Coupon coupon) throws CouponException, SQLException {
		coupDAO.updateCoupon(coupon);
	}

	public Coupon getCoupon (long coupId)throws CompanyFacadeException, SQLException 
	{
		try {
	...
	public Collection <Coupon> getAllCoupon() throws CompanyFacadeException, CouponException, SQLException
	{ 
	...
	public Collection <Coupon> getCouponByType (CouponType couponType) throws CompanyFacadeException, CouponException, SQLException
	{
	...
	public Collection <Coupon> getCouponsByEndDate(LocalDate Date) throws CompanyFacadeException, CouponException, SQLException{
...
public Collection <Coupon> getCouponsByPrice(double price) throws CompanyFacadeException, CouponException, SQLException{
